  ...
  return (
    <ProfileStyles.Wrapper>
      <ProfileStyles.ImageContainer>
        ...
        <ProfileStyles.Account>{name}</ProfileStyles.Account>
        <ProfileStyles.Rating>
          {Array.from(Array(rating), (_, index) => (
            <StarTwoTone key={index} twoToneColor="red" style={{ fontSize: 14 }} />
          ))}
        </ProfileStyles.Rating>
        <ProfileStyles.StyledLink to="/">내 상점 관리</ProfileStyles.StyledLink>
      </ProfileStyles.ImageContainer>
      <ProfileStyles.InfoContainer>
        <ProfileStyles.Account style={{ color: 'black' }}>{name}</ProfileStyles.Account>
        <ProfileStyles.DetailContainer>
          <ProfileStyles.Detail>상점 오픈일</ProfileStyles.Detail>
          <ProfileStyles.Detail>상점 방문수</ProfileStyles.Detail>
          <ProfileStyles.Detail>상품 판매</ProfileStyles.Detail>
          <ProfileStyles.Detail>택배 발송</ProfileStyles.Detail>
        </ProfileStyles.DetailContainer>
        <div>소개글</div>
      </ProfileStyles.InfoContainer>
    </ProfileStyles.Wrapper>
